...
/* TODO
   ...
   - Make server info + username persistent on all relevant screens
                    ...
                    if (userInput.equalsIgnoreCase("y")) {
                        ...
                        if (spaceInd1 == -1) { //List and number unseparated
                            ...
                            if (findSpace(userInput.substring(spaceInd1 + 1, userInput.length())) != -1) { //if two args
                                int spaceInd2 = findSpace(userInput.substring(spaceInd1 + 1, userInput.length()));
                                minMsg = Integer.parseInt(userInput.substring(spaceInd1 + 1, spaceInd2)); //first arg
                                maxMsg = Integer.parseInt(userInput.substring(spaceInd2, userInput.length())); //2nd arg
